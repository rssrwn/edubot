...
\begin{itemize}
  ...
  \item However, it must take students from the basic right up to the more advanced concepts. We will aim to integrate all the topics stipulated in the national curriculum.
  \item The programming section of the application will be delivered in a visual form, separated from the syntax of specific languages. This allows the application to focus on teaching programmatic thinking and avoids the danger of discouraging students with unintuitive syntax and syntax errors.
\end{itemize}}  
